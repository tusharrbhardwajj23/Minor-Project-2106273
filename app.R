...
ui <- dashboardPage(
  dashboardHeader(title = 'Cric Info'
  ),
  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = 'about',
              ...
              March or April and May of every year by Ten teams representing Ten different cities in India.
              ...
              league in the world and in 2014 ranked sixth by average attendance among all sports leagues.It was the brainchild of Lalit Modi.', 
                     style = 'font-size: 120%;margin-left:2.5em;'),
              h3('Teams of the League', align = 'center'),
              
              fluidRow(
                shinydashboard::box(width = 12, background = 'light-blue',
                                    ...
                                    valueBox(tags$p('Sunrises Hyderabad (SRH)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'SRH.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Delhi Capitals (DC)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'DC.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Kolkata Knight Riders (KKR)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'KKR.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Kings XI  Punjab (KXIP)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'KXI.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    ...
                                    valueBox(tags$p('Deccan Chargers (DC)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'deccan.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Delhi Daredevils (DD)', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'Delhi.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Lucknow super giants', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'LSG.png', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black'),
                                    valueBox(tags$p('Gujrat Titans', style = 'font-size: 30%;text-align: center;'), 
                                             div(img(src = 'GT.jpg', height = '120', width = '160'),style='text-align: center;'), 
                                             icon = NULL, width = 4, color = 'black')
      ...
      tabItem(tabName = 'summary',
              ...
              shinydashboard::box(title = 'Overview(Dataset provided from 2008-2019)',
                                  width = 12,
                                  solidHeader = T, 
                                  collapsible = F,
                                  background  = 'black',
              ...
              shinydashboard::box(title = 'Season Winners',
                                  ...
                                  fluidRow(
                                    ...
                                    valueBox(tags$p('2009', style = 'font-size: 40%;text-align: center;'), div(img(src = 'DC.jpg', height = '80', width = '100'),style='text-align: center;'), 
                                             icon = NULL, width = 2, color = 'black'),
                                    ...
                                    valueBox(tags$p('2011', style = 'font-size: 40%;text-align: center;'), div(img(src = 'CSK.jpg', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2012', style = 'font-size: 40%;text-align: center;'), div(img(src = 'KKR.jpg', height = '80', width = '100'),style='text-align: center;'), 
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2013', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.png', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2014', style = 'font-size: 40%;text-align: center;'), div(img(src = 'KKR.jpg', height = '80', width = '100'),style='text-align: center;'), 
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2015', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.png', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2016', style = 'font-size: 40%;text-align: center;'), div(img(src = 'SRH.jpg', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    ...
                                    valueBox(tags$p('2019', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.png', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2020', style = 'font-size: 40%;text-align: center;'), div(img(src = 'MI.png', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2021', style = 'font-size: 40%;text-align: center;'), div(img(src = 'CSK.jpg', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2022', style = 'font-size: 40%;text-align: center;'), div(img(src = 'GT.jpg', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black'),
                                    valueBox(tags$p('2023', style = 'font-size: 40%;text-align: center;'), div(img(src = 'CSK.jpg', height = '80', width = '100'),style='text-align: center;'),  
                                             icon = NULL, width = 2, color = 'black')
                                  )
              ),
              ...
              shinydashboard::box(title = 'Orange Cap Winners',
                                  ...
                                  shinydashboard::box( background  = 'black',width = 12,
                                                       ...
                                                       valueBox(tags$p('2019 - David Warner (SRH)', style = 'font-size: 30%;text-align: center;'), div(img(src = "warner.jpg", 
                                                                                                                                                           height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2020 - KL Rahul (PKXI)', style = 'font-size: 30%;text-align: center;'), div(img(src = "KL.jpg", 
                                                                                                                                                           height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2021 - Rituraj gaikwad (csk)', style = 'font-size: 30%;text-align: center;'), div(img(src = "RITU.jpg", 
                                                                                                                                                        height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2022 - Jos butler (RR)', style = 'font-size: 30%;text-align: center;'), div(img(src = "JOS.jpg", 
                                                                                                                                                        height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'),
                                                       valueBox(tags$p('2023 - Subhman Gill (GT)', style = 'font-size: 30%;text-align: center;'), div(img(src = "SUBH.jpg", 
                                                                                                                                                        height = '80', width = '100'),style='ext-align: center;'), icon = NULL, width = 2, color = 'black'))
              ),
              ...
              shinydashboard::box(title = 'Purple Cap Winners',
                                  ...
                                  shinydashboard::box( background  = 'black',width = 12,
                                                       ...
                                                       valueBox(tags$p("2010 -  Pragyan Ojha (DC)", style = "font-size: 30%;text-align: center;"), div(img(src = "ojha.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2011 - Lasith Malinga (MI)", style = "font-size: 30%;text-align: center;"), div(img(src = "malinga.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2012 - Morne Morkel (DD)", style = "font-size: 30%;text-align: center;"), div(img(src = "morkel.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2013 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "bravo.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2014 - Mohit Sharma (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "mohit.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2015 - Dwayne Bravo (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "bravo.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       ...
                                                       valueBox(tags$p("2018 - Andrew Tye (KXIP)", style = "font-size: 30%;text-align: center;"), div(img(src = "tye.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2019 - Imran Tahir (CSK)", style = "font-size: 30%;text-align: center;"), div(img(src = "tahir.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2020 - KAGISO RABADA (DC)", style = "font-size: 30%;text-align: center;"), div(img(src = "KG.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2021 - Harshal patel (RCB)", style = "font-size: 30%;text-align: center;"), div(img(src = "HP.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2022 - Yuzwendra chahal (RR)", style = "font-size: 30%;text-align: center;"), div(img(src = "YZ.jpg", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                                       valueBox(tags$p("2023 - Mohammed Shami (GT)", style = "font-size: 30%;text-align: center;"), div(img(src = "shami.png", height = "80", width = "100"),style="text-align: center;"), 
                                                                icon = NULL, width = 2, color = "black"),
                                  )
              ),
      ),
              ...
              fluidPage(
                ...
                fluidRow(
                  shinydashboard::box( title = 'Teams Represented', 
                                       width = 4, solidHeader = TRUE, background = 'teal',
                                       uiOutput('teamsplayedui')),
                  
                  shinydashboard::box(
                    title = 'Batting', 
                    width = 4, solidHeader = TRUE, background = 'fuchsia',
                    uiOutput('batting_ui')
                    
                  ),
                  shinydashboard::box(
                    title = 'Bowling', width = 4, solidHeader = TRUE, background = 'maroon',
                    uiOutput('bowling_ui')
